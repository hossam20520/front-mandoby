...
export default {
    en_title:'الاسم بالانجلزي',
    Enter_en_title_Product:'ادخل اسم المنتج باللغة الانجليزية',
    ar_title:'الاسم  بالعربي',
    Enter_ar_title_Product:'ادخل اسم المنتج بالعربي ',
    desc:'تفاصيل المنتج (يجب ادخالها)',
    Enter_ar__name_category:'ادخل اسم الفئة بالعربي',
    Enter_en_name_category:'ادخل اسم الفئة بالانجليزي',
    CategoryImage:'صورة الفئة',
    PriceLists:'قائمة الاسعار',
    Enter_ar_name_priceList:'ادخل عنوان لقائمة الاسعار بالعربي',
    Enter_en_name_priceList:'ادخل عنوان لقائمة الاسعار بالانجليزي',
    is_active:'نشط',
    oldPrice:'السعر القديم',
    newPrice:'السعر الجديد',
    discount:'الخصم',
    priceListN:'اسم قائمة الاسعار',
    alreadyExist:'المنتج موجود بالفعل',
    desca:'تفاصيل',
    Enter_ar_Name_Brand:'ادخل اسم الشركة بالعربي',
    Enter_en_Name_Brand:'ادخل اسم الشركة بالانجليزي',
    en_titleEnter_Name_Unit:'ادخل اسم الوحدة بالانجليزي',
    ar_titleEnter_Name_Unit:'ادخل اسم الوحدة بالعربي',
    ...
    Enter_Name_Brand: 'أدخل اسم الشركة',
    Enter_Description_Brand: 'أدخل وصف الشركة ',
    ...
    BrandImage: 'صورة الشركة',
    BrandName: 'اسم الشركة',
    BrandDescription: 'ةصف الشركة',
